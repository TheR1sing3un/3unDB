...
public class TupleDesc implements Serializable {
    ...
    private ArrayList<TDItem> items = null;
    ...
    public boolean equals(Object o) {
        ...
        for (int i = 0; i < this.items.size(); i++) {
            if (!this.items.get(i).fieldType.equals(tupleDesc.items.get(i).fieldType)) {
                return false;
            }
        }
        return true;
    ...
    public String toString() {
        ...
        for (int i = 0; i < this.items.size(); i++) {
            sb.append("[" + i + "]" + this.items.get(i).toString());
        }
        return sb.toString();
    }
}
